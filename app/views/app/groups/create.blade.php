...
<div class="page-header">
	<h3>
		...
		<div class="pull-right">
			<a href="{{ route('groups.index') }}" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-circle-arrow-left"></i> @lang('groups/messages.create.back')</a>
		</div>
	</h3>
</div>
			...
			<div class="col-md-36">
				...
				<div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
					<fieldset class="form-inline">
						<div class="row">
							<div class="col-md-20">
								<label class="control-label" for="name">@lang('groups/messages.create.name')</label>
							</div>
